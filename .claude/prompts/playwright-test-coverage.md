---
agent: default
description: Plan, generate, and heal E2E tests for a feature
---

Parameters:

- Task: the feature to cover (e.g. "chat management", "message sending", "settings")
...
<generate>
  <test-suite><!-- Verbatim name of the test spec group w/o ordinal like "Chat management tests" --></test-suite>
  <test-name><!-- Name of the test case without the ordinal like "should create a new chat" --></test-name>
  <test-file><!-- Name of the file to save the test into, like e2e/chat/should-create-a-new-chat.spec.ts --></test-file>
